...
public interface IKVServer {
    ...
    /**
     * Writes to the JSON file, this could be to create the file or update the file.
     */
    public void writeToStorage(Map<String,String> kvs, String dataPath);

    /**
     * initializes the hashmap/cache used while the application is running to hold
